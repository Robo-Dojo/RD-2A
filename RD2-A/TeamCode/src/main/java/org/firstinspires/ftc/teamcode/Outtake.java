...
public class Outtake {
    ...
    public void clawPivotLongController(Gamepad _gamepad1) {
        ...
        telemetry.update();
        if (_gamepad1.x) {
            rd1.clawPivotLong.setPosition(0.35);
