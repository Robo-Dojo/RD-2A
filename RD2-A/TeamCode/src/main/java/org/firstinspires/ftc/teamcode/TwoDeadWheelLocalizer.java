...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -9450.763487679695; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 15137.680668995532; // x position of the perpendicular encoder (in tick units)
    }
