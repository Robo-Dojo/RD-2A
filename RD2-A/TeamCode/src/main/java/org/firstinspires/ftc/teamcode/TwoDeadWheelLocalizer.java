...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -9126.987409808975; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 14863.730459168952; // x position of the perpendicular encoder (in tick units)
    }
