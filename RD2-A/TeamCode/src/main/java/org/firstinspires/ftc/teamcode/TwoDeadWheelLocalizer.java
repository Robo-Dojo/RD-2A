...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 9660.395415751931; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -12060.468495975578; // x position of the perpendicular encoder (in tick units)
    }
